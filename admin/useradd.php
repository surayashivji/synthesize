    ...
    <div id="outercontainer">
        ...
        <div id="mainHead">
            ...
            <form action="insertuser.php" method = "post" enctype="multipart/form-data">
               <span id="header"> Upload a profile Picture!  <input type="file" name="thefile"></span>


                <br>

             <span id="header">  First Name:</span> <input  type="text" name="firstname" value=""></br>
                <span id="header">Last Name:</span><input type="text" name="lastname" value=""></br>
                    <span id="header">Email:</span><input type="text" name="email" value=""></br>
                        <span id="header"> Username:</span><input type="text" name="username" value=""></br>
                            <span id="header"> Password:</span><input type="text" name="password" value=""></br></br>
