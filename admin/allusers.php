...
<div id="resultsusers">
            ...
            while($currentrow = mysqli_fetch_array($results)) {
                ...
                echo "<center><div class='firstname'>" .  $currentrow['firstname'] . "</div>";
                echo  "<div class='lastname'>" . $currentrow['lastname'] . "</div>";
                echo  "<div class='email'>" . $currentrow['email'] . "</div>";
                echo  "<div class='username'>" . $currentrow['username'] . "</div>" .
                    " <div class='editdlt'> <a href = 'useredit.php?id=" .
                    $currentrow['user_id'] .
                    "'>[Edit]</a>" .
                    " <a href = 'userdelete.php?id=" .
                    $currentrow['user_id'] .
                    "'>[Delete]</a>" .
                    " <a href = 'useradd.php?id=" .
                    $currentrow['user_id'] .
                    "'>[Add]</a>" .
                    "</div>"  .
