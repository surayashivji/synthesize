...
<center>
    ...
    <div id="outercontainer">
        ...
        <div id="mainHead">
            ...
            <form action="insertsketch.php" method = "post" enctype="multipart/form-data">
              <span id="header">Upload a thumbnail!

                <input type="file" name="thumbnail"></span>
                <br>

                <span id="header">  Name:<input type="text" name="name" value=""> </span></br>
</br>
