    ...
    <div id="outercontainer">
        ...
        <div id="mainHead">
            ...
            if(empty($_REQUEST['id'])){
                ...
                echo "<div id='header'>You reached this page in error</div>";
                exit();
            }
...
<div id ="header">
            ...
            <form action="userupdate.php" >
                ...
                Edit first name:
                <input class="header"type="text" value="<?php echo  $recordinfo['firstname'];?>" name="firstname">

                </input>
                <br>  <br>
                Edit last name:
                <input type="text" value="<?php echo  $recordinfo['lastname'];?>" name="lastname">

                </input>
                <br>  <br>
                Edit email:
                <input type="text" value="<?php echo  $recordinfo['email'];?>" name="email">

                </input>
                <br>  <br>
                Edit username:
                <input type="text" value="<?php echo  $recordinfo['username'];?>" name="username">
                ...
                <input type='hidden' name='id' value='<?php echo $recordinfo['user_id'];?>'/>
